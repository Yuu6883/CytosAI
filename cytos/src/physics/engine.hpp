...
struct Engine {
    ...
    virtual void addHandle(Handle* handle, uint16_t id = 0);
    ...
    virtual const size_t boostSize() { return 0; };
    ...
    virtual void handleOutput(float dt){};
    ...
    virtual bool freeHandle(Handle* handle);
    ...
    virtual void onExtCommand(string_view cmd){};
...
constexpr float QuadTreeE = 0.25f;

typedef QuadTree Solver;
