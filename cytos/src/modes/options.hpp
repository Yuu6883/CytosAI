...
static inline std::string_view COMPILE_TIME(__DATE__ " " __TIME__);
...
struct OPT {
    ...
    size_t MAX_WH_CELLS = 0;

    float WH_CELL_SIZE = 750;
    float WH_CELL_MAX_SIZE = 800;
    float WH_EXPANSION = 5.f;
    float WH_GRAVITY = 100.f;
    float WH_EAT_MULTI = 5.f;
    ...
    cell_cord_prec VIRUS_MAX_BOOST = 700.f;
